...
"""
Command-line interface for analyzing web pages using AI.

This script fetches the content of a web page, generates a summary
using LLM clients (OpenAI or Ollama), formats the summary, and saves
it to a file in the specified format.
"""
...
def main() -> None:
    ...
    Parses command-line arguments, initializes LLM clients and services,
    and runs the summarization pipeline. The output is saved to a file
    and optionally printed to the console.
    """
    try:
        ...
        summary_service = SummaryService[LLMModelParams, PromptInput, PromptOutput](
        ...
        format_writer_service = FormatterWriterService[PromptOutput]()
        _ = summary_service(
            summary_args,
            args.prompt_path,
            args.format,
